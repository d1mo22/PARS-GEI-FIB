...
enforceEachEventExactlyOneModerator:- 
        event(E),  
        findall(em(E,M), moderator(M), Lits),  
        exactly(1,Lits), fail.
enforceEachEventExactlyOneModerator:- 
...
enforceNotSameDayModerators:-   %% Complete this!
       notSameDayModerators(M1,M2), day(D),
...
enforceBefore:-                  %% Complete this!
        ...
        day(D1), day(D2),
        D1 >= D2,
        writeOneClause([-ed(E1,D1), -ed(E2,D2)]),fail.
enforceBefore.

enforceAllDifferentDaysEvents:-  %% Complete this!
        allDifferentDaysEvents(L),
        member(E1,L), member(E2,L), E1 \= E2, day(D),
