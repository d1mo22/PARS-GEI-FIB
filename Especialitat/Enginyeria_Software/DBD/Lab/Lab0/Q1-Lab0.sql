...
INSERT INTO  EMPLEATS VALUES (4,'EULALIA',25000,'MADRID',5,null);

COMMIT;

--Retrieve the names of employees of the department number 5 and the building where they work.
--The result must be sorted by ascending name.
