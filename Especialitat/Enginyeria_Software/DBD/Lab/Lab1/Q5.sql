...
SELECT p.IDPRODUCTE, d.NOMCARRER, count(l.NUMCOMANDA) AS "n"
FROM PRODUCTES p CROSS JOIN DOMICILIS d
LEFT JOIN COMANDES c ON c.NUMTELF = d.NUMTELF
LEFT JOIN LINIESCOMANDES l ON l.NUMCOMANDA = c.NUMCOMANDA AND l.IDPRODUCTE = p.IDPRODUCTE
