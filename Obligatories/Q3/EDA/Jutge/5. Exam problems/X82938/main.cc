...
int buscaPosCim(const vector<int> &v, int esq, int dre) {
  ...
  int mid = (esq + dre) / 2;
  if (v[mid] < v[mid - 1])
    return buscaPosCim(v, esq, mid - 1);
  else if (v[mid] < v[mid + 1])
    return buscaPosCim(v, mid + 1, dre);
  return mid;
}
...
bool searchCre(int x, const vector<int> &v, int esq, int dre) {
  ...
  int mid = (esq + dre) / 2;
  if (v[mid] > x)
    return searchCre(x, v, esq, mid - 1);
  else if (v[mid] < x)
    return searchCre(x, v, mid + 1, dre);
  return true;
}
...
bool searchDec(int x, const vector<int> &v, int esq, int dre) {
  ...
  int mid = (esq + dre) / 2;
  if (v[mid] < x)
    return searchDec(x, v, esq, mid - 1);
  else if (v[mid] > x)
    return searchDec(x, v, mid + 1, dre);
  return true;
}
