...
int Color(carta mano[5]) {
  return (mano[0].palo == mano[1].palo) && (mano[0].palo == mano[2].palo) &&
         (mano[0].palo == mano[3].palo) && (mano[0].palo == mano[4].palo);
}
...
int Full(carta mano[5]) {
  ...
  caso1 = (mano[0].num == mano[1].num) && (mano[0].num == mano[2].num) &&
          (mano[3].num == mano[4].num);
  caso2 = (mano[0].num == mano[1].num) && (mano[2].num == mano[3].num) &&
          (mano[2].num == mano[4].num);
...
int Escalera(carta mano[5]) {
  ...
  caso1 = (mano[0].num == (mano[1].num - 1)) &&
          (mano[0].num == (mano[2].num - 2)) &&
          (mano[0].num == (mano[3].num - 3)) &&
          (mano[0].num == (mano[4].num - 4));
  caso2 = (mano[0].num == 0) && (mano[1].num == 1) && (mano[2].num == 2) &&
          (mano[3].num == 3) && (mano[4].num == 12);
...
int main(int argc, char *argv[]) {
  ...
  printf("%7d COMBINACIONES:\n - ESCALERA COLOR (%d)\n - POKER (%d)\n - FULL "
         "(%d)\n - COLOR (%d)\n - ESCALERA (%d)\n - TRIO (%d)\n - DOBLE PAREJA "
         "(%d)\n - PAREJA (%d)\n - NADA (%d) \n",
         tot, escaleracolor, poker, full, color, escalera, trio, doblepareja,
         pareja, nada);
